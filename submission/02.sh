...
# Derivation: decoderawtransaction on the hex shows the vin scriptSig. After the two signatures,
# the last data push is the serialized redeem script. decodescript on that hex shows OP_2, two pubkeys,
# OP_2, OP_CHECKMULTISIG (2-of-2 multisig). The answer is that push as contiguous hex (no 0x prefix in output).
echo 522102da2f10746e9778dd57bd0276a4f84101c4e0a711f9cfd9f09cde55acbdd2d1912102bfde48be4aa8f4bf76c570e98a8d287f9be5638412ab38dede8e78df82f33fa352ae
